...
<html lang="en">
    <head>
        ...
        <meta HTTP-EQUIV="refresh" content="5; URL=form_altaproducto.html">
        <meta charset="UTF-8">
    ...
    <?php
        if(isset($_POST['nombre'] )and $_POST['nombre']!=""){
            ...
            $sql = "INSERT INTO productos (name,img,descripcion,precio_entrada,precio_salida,codigo_barras,stock,estado,bolsasxcaja,gramosxbolsa,CATEGORIA_PRODUCTOS_idCATEGORIA_PRODUCTOS) 
            VALUES ('$nombre','$img','$descripcion','$precio_entrada','$precio_salida','$codigo_barras','$stock','$estado','$bolsasxcaja','$gramosxbolsa','$CATEGORIA_PRODUCTOS_idCATEGORIA_PRODUCTOS')";
